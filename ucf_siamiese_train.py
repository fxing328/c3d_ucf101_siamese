...
if __name__ =='__main__':
    ...
    try:
	    ...
	    with open('ucf_siamiese_train1.txt','w') as filelist_1:
	      with open('ucf_siamiese_train2.txt','w') as filelist_2:
		with open('c3d_ucf101_my_train1.txt','rb') as trainOri:
		  ...
		  while True:
		      ...
		      #same label
		         ...
		         posline_tmp_1 = linecache.getline('c3d_ucf101_my_train1.txt',possel_index[0]+1)
		         posline_tmp_2 = linecache.getline('c3d_ucf101_my_train1.txt',possel_index[1]+1)
		         ...
		         #pdb.set_trace()
		         neg_label = np.random.choice(101,2)
