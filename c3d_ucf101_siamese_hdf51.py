...
if __name__=='__main__':
   ...
   # solver.net.copy_from('/scratch/xf362/c3d_ucf101/model/test_new_33000.000000')
    ...
    solver.net.copy_from('/scratch/xf362/c3d_ucf101_siamese/model_hdf5_fc6_m150/siamesehdf5_new_26000.000000')
   ...
   # vis_square(filters.transpose(0, 2, 3, 1),'test_image_init.png')
    ...
    with open('train_siamense_hdf5_log1.txt','a') as txt_file:
	    ...
	    print 'train_loss: '+ str(train_loss[it]) + " std :" + str(solver.net.params['fc6'][0].data.std()) +"iteration: " +str(it+26000)
		...
		txt_file.write('iteration: '+ str(it+26000)+  ' test_loss: '+str(loss) +'\n')		
           	solver.net.save('model_hdf5_fc6_m150/siamesehdf5_new_%f'%(it+26000))
