...
if __name__=='__main__':
   ...
   # solver.net.copy_from('/scratch/xf362/c3d_ucf101/model/test_new_33000.000000')
    solver.net.copy_from('/scratch/xf362/c3d_ucf101_siamese/test_new_57000.000000')
    #solver.net.copy_from('/scratch/xf362/c3d_ucf101_siamese/model_hdf5_fc6_m150/siamesehdf5_new_11000.000000')
    ...
    pdb.set_trace()
    filterstrans = filters.transpose(0, 3, 4, 2, 1)
    fil['flconv0'] = filterstrans
    scipy_io.savemat(open('filters_conv0.mat','wb'), fil)
    filtersData = filterstrans[:,:,:,:,0]
    
    vis_square(filtersData,'test_image_init.png')
    ...
    with open('train_siamense_hdf5_log1.txt','a') as txt_file:
    	for it in range(niter):
            solver.step(1)  # SGD by Caffe
            #pdb.set_trace()
 	    train_loss[it] = solver.net.blobs['loss'].data
	    #print 'train_loss'+ str(train_loss[it])
	    print 'train_loss: '+ str(train_loss[it]) + " std :" + str(solver.net.params['fc6'][0].data.std()) +"iteration: " +str(it+11000)
		...
		txt_file.write('iteration: '+ str(it+11000)+  ' test_loss: '+str(loss) +'\n')		
           	solver.net.save('model_hdf5_fc6_m150/siamesehdf5_new_%f'%(it+11000))
