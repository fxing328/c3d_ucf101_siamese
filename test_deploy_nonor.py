...
if __name__ =='__main__':
    caffe.set_mode_gpu()
    net = caffe.Net('./c3d_ucf101_siamese_train_test_hdf5.prototxt','/scratch/xf362/c3d_ucf101_siamese/model_hdf5_fc6_m150/siamesehdf5_new_26000.000000',caffe.TEST)
    iteration = 1000
    pos = []
    neg = []
    testRes = {}
    for i in range(iteration):
      data = net.forward()
      data1 = net.blobs['fc6'].data
      data2 = net.blobs['fc6_p'].data
      for j in range(5):	
        if data['label'][j,:] == 1:
