...
if __name__ =='__main__':
   ...
   with open("ucf_siamiese_test1.txt") as txt_file1:
       l1 = txt_file1.readlines()
   with open("ucf_siamiese_test2.txt") as txt_file2:
  ...
  # while linenum < whole_pair:    
   ...
   for s in range(n):
     ...
     with  h5py.File('testing_pair_mean/testing_pair'+str(s)+'.h5','w') as f1_pair:
